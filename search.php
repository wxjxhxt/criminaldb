...
<html>
   ...
   // Display table header
                     echo '
                     <table border="5" style="position:relative;left:-180px;top: 65px;diaplay:none">
                  <tr>
                     <th>Criminal Image</th>
                     <th>Criminal ID</th>
                     <th>Criminal Name</th>
                  ...
                  echo "No results"; // If there are no records in the database
               }
